...
fetched: 2026-08-11
status: complete
notes: fetched verbatim via curl; HTTP 200; content ends with the page's "Related/See also" link list (full page). First 3 lines of upstream body are an upstream-injected "Documentation Index" banner, preserved as-is.
-->
