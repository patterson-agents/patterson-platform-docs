...
fetched: 2026-08-11
status: complete
notes: No redirect (final URL identical to requested URL). Stripped site chrome: top nav, left "Core Editor"/"Topics" tree, "Copy as Markdown" widget, "On this page" list, footer social/legal links, banner. Page metadata ms.date 02/04/2026. No garbled inline setting links were present on this page, so no setting-ID normalization was needed. Image references and links preserved as in source.
-->

# Profiles in Visual Studio Code

Visual Studio Code has hundreds of [settings](https://code.visualstudio.com/docs/configure/settings), thousands of [extensions](https://code.visualstudio.com/docs/configure/extensions/extension-marketplace), and innumerable ways to adjust the UI layout to customize the editor. VS Code **Profiles** let you create sets of customizations and quickly switch between them or share them with others. This topic explains how to create, modify, export, and import profiles by using the **Profiles editor**.

## Access the Profiles editor

The **Profiles editor** enables you to create and manage your profiles in VS Code from a single place. The Profiles editor opens by default in a [modal overlay](https://code.visualstudio.com/docs/editing/userinterface#_modal-editors) on top of the editor area.

![Screenshot that shows the Profiles editor.](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor.png)

You can access the Profiles editor in either of the following ways:

- From the **File** > **Preferences** > **Profiles** menu item

    ![Profiles editor Menu Item](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-menu-item.png)

- From the **Manage** gear button in the bottom of the Activity Bar.

    ![Profiles editor via the Manage button in the Activity bar](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-via-manage.png)
...
![Create Profile](https://code.visualstudio.com/assets/docs/configure/profiles/create-profile.png)
...
![Copy from options](https://code.visualstudio.com/assets/docs/configure/profiles/copy-from.png)
...
![Configure, browse and preview profile](https://code.visualstudio.com/assets/docs/configure/profiles/configure-browse-preview.png)
...
- In the hover text when you hover over the **Manage** button in the Activity Bar
    ...
    ![Manage gear displaying icon to indicate that the user's profile is active](https://code.visualstudio.com/assets/docs/configure/profiles/profile-gear-icon.png)
    ...
    ![Manage gear displaying 'DA' to indicate that the user's 'Data Science' profile is active](https://code.visualstudio.com/assets/docs/configure/profiles/profile-gear-two-letters.png)

- In the Profiles editor

    ![Showing current profile in the Profiles editor](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-in-use-profile.png)
...
![Folders & Workspaces section](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-folders-workspaces.png)
...
![Switch profile from the Profiles editor](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-switch-profile.png)
...
![Delete profile from the Profiles editor](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-delete-profile.png)
...
![Configure custom profile for new window](https://code.visualstudio.com/assets/docs/configure/profiles/profile-new-window.png)
...
![Apply setting to all Profiles](https://code.visualstudio.com/assets/docs/configure/profiles/profiles_apply_setting.png)
...
![Apply an extension to all Profiles](https://code.visualstudio.com/assets/docs/configure/profiles/profiles_apply_extension.png)
...
You can use [Settings Sync](https://code.visualstudio.com/docs/configure/settings-sync) to move your profiles across various machines. With Setting Sync enabled and **Profiles** checked in the **Settings Sync: Configure** drop down, all your profiles are available on the synced machines.

![Settings Sync data drop down with Profiles checked](https://code.visualstudio.com/assets/docs/configure/profiles/settings-sync-profiles.png)
...
![Export profile from the Profiles editor](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-export-profile.png)
...
![Import profile from the Profiles editor](https://code.visualstudio.com/assets/docs/configure/profiles/profiles-editor-import-profile.png)

When you select **Import Profile...**, you are prompted for the URL of a GitHub gist or the file location of a profile via an **Import Profile** dialog. Once you have selected the profile, the [Profile creation form](#_create-a-profile) opens with the profile to import preselected. You can continue to modify the profile and select **Create** to import the profile.
