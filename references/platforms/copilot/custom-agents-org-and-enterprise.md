...
fetched: 2026-08-11
status: complete
notes: Fetched via web_fetch (HTML->text). Nav chrome stripped. THIS is the closest thing to "organization-level / enterprise-level custom instructions" as a FILE-based mechanism: agent profiles at repo (.github/agents/), org (/agents/ in .github or .github-private), and enterprise (/agents/ in a designated org's .github-private) levels.
-->
...
- [Where you can configure custom agents](#where-you-can-configure-custom-agents)
- [Where you can use custom agents](#where-you-can-use-custom-agents)
