...
fetched: 2026-08-11
status: complete
notes: Fetched via web_fetch (HTML->text), tool=webui variant. Nav chrome stripped; article body reproduced faithfully including the full onboarding prompt code block and the applyTo / excludeAgent frontmatter examples. This page ALSO contains the precedence note (personal > repository > organization) and the path-specific instructions schema.
-->
...
1. Go to the agents tab at [github.com/copilot/agents](https://github.com/copilot/agents).
